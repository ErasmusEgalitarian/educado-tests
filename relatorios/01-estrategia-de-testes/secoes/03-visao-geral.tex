...
O projeto está distribuído em quatro repositórios públicos: educado-web, educado-api, educado-app e educado-docs.
Por recomendação da disciplina, este trabalho terá como objeto principal o educado-web, responsável pela interface web utilizada por criadores de conteúdo e administradores.
Entretanto, algumas atividades poderão envolver o educado-api, pois funcionalidades e testes de integração da interface dependem dos serviços fornecidos pelo backend.
...
Essa dependência poderá exigir a utilização ou modificação da API durante a criação de alguns testes de integração.
